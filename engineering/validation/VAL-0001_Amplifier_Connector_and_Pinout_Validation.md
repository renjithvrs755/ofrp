...
## Passive sequence for SRC-0002 reported output pairs

This sequence evaluates a `V1` community report; it does not presume the pairs
are outputs or that the reported polarity is correct.

1. Confirm `CON-0001` cavity count and numbering from molded evidence.
2. Confirm and photograph both mating-face and wire-entry-face views, including
   latch/key orientation; reconcile the mirrored numbering with a reviewer.
3. Map every retained pigtail wire color to a cavity under neutral lighting.
4. With all equipment de-energized, execute `TEST-0002` for each reported pair.
5. Record raw resistance between the two reported pins in both lead directions.
6. Measure each reported pin to amplifier chassis and record raw readings.
7. Measure channel-to-channel isolation using a reviewed matrix that avoids
   indiscriminate probing and records every endpoint.
8. Document any unexpected continuity, instability, polarity dependence, or
   contradiction without reassigning a function.

Expected thresholds remain pending instrument characterization and engineering
review. A pair cannot pass merely because an audible continuity indicator sounds.

| Reported channel | Pair | Pair resistance | Pin A–chassis | Pin B–chassis | Channel isolation | Unexpected continuity/anomaly | Evidence IDs | Pass/fail |
|---|---|---|---|---|---|---|---|---|
| LF woofer | 18–6 | Not measured | Not measured | Not measured | Not measured | Not assessed | Pending | Not evaluated |
| LF midrange | 13–14 | Not measured | Not measured | Not measured | Not measured | Not assessed | Pending | Not evaluated |
| LF tweeter | 8–20 | Not measured | Not measured | Not measured | Not measured | Not assessed | Pending | Not evaluated |
| RF woofer | 15–3 | Not measured | Not measured | Not measured | Not measured | Not assessed | Pending | Not evaluated |
| RF midrange | 12–11 | Not measured | Not measured | Not measured | Not measured | Not assessed | Pending | Not evaluated |
| RF tweeter | 19–7 | Not measured | Not measured | Not measured | Not measured | Not assessed | Pending | Not evaluated |
| LR speaker | 9–21 | Not measured | Not measured | Not measured | Not measured | Not assessed | Pending | Not evaluated |
| RR speaker | 22–10 | Not measured | Not measured | Not measured | Not measured | Not assessed | Pending | Not evaluated |
| Sub coil 1 | 16–4 | Not measured | Not measured | Not measured | Not measured | Not assessed | Pending | Not evaluated |
| Sub coil 2 | 5–17 | Not measured | Not measured | Not measured | Not measured | Not assessed | Pending | Not evaluated |
