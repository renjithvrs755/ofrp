...
| `BLD` | Build-log record | `BLD-0001` |
| `SRC` | Controlled source-extraction review | `SRC-0001` |
| `BENCH` | Bench setup or fixture plan | `BENCH-0001` |
| `PHOTO-PLAN` | Controlled photography plan | `PHOTO-PLAN-0001` |
